 ...
 * @author Andy Clement
 */
class DelayInitJsonConverter {

	public JSONObject toJsonArray(DelayInitDescriptor metadata) throws Exception {
		JSONObject object = new JSONObject();
		JSONArray jsonArray = new JSONArray();
		for (String p : metadata.getClasses()) {
			jsonArray.put(toJsonObject(p));
		}
		object.put("delayClassInitialization", jsonArray);
		return object;
	}
